...
<html lang="fr">
    ...
    <body class="body-form-modif">
        ...
        <form method="POST" action="../ajout.php?table=activite">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">Coût</label>
                <input type="text" name="cout" class="form-control" id="formGroupExampleInput2" placeholder="Coût" value=<?="{$result['cout']}"?>>
            </div>

            <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">Prix</label>
                <input type="text" name="prix" class="form-control" id="formGroupExampleInput2" placeholder="Prix" value=<?="{$result['prix']}"?>>
            </div>
